...
function validateCoreFields(input: ProductSpecInput, allowPartial: boolean): void {
...
export function validateCreateProductSpecInput(input: ProductSpecInput): void {
  validateCoreFields(input, false);
}

export function validateUpdateProductSpecInput(input: ProductSpecInput): void {

...
function validateCore(input: ProductSpecInput, allowPartial: boolean): void {
...
export const validateCreateProductSpecInput = (input: ProductSpecInput) =>
  validateCore(input, false);

export const validateUpdateProductSpecInput = (input: ProductSpecInput) =>
  validateCore(input, true);
